...
SpellInfo = {
    ['Default'] = {
        ...
        -- vegura
        ['Strike'] = { id = 200, words = 'exori flam', exhaustion = 2000, premium = true, type = 'Instant', icon = 'strike', mana = 20, level = 14, soul = 0, group = { [1] = 2000 }, vocations = { 1, 2, 5, 6 } },
        ['Ultimate Explosion'] = { id = 24, words = 'exevo gran mas vis', exhaustion = 40000, premium = true, type = 'Instant', icon = 'hellscore', mana = 1100, level = 60, soul = 0, group = { [1] = 4000 }, vocations = { 1, 5 } },
    }--[[,
